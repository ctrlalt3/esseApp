...
<body class="flex bg-zinc-300 text-stone-800 overflow-hidden scrollbar-none">
    ...
    <div class="flex p-4 w-4/12 h-6/6 right-0 flex-col justify-start items-center rounded-lg">
